...
class ChatRepository:
    ...
    def create_session(self, project_id: int, user_id: int, title: Optional[str] = None) -> ChatSession:
    ...
    def get_user_sessions(self, project_id: int, user_id: int) -> List[ChatSession]:
